...
//    int is_enabled;
//
//    is_enabled = (IsDlgButtonChecked(hwnd, IDC_PLUS60K_ENABLE) == BST_CHECKED) ? 1 : 0;
//
...
//    CheckDlgButton(hwnd, IDC_PLUS60K_ENABLE, res_value ? BST_CHECKED : BST_UNCHECKED);
//    
...
//    SetDlgItemText(hwnd, IDC_PLUS60K_FILE, plus60kfile != NULL ? st_plus60kfile : TEXT(""));
...
//    char s[MAX_PATH];
//
//    resources_set_int("PLUS60K", (IsDlgButtonChecked(hwnd, IDC_PLUS60K_ENABLE) == BST_CHECKED ? 1 : 0 ));
//
...
//{
//    DialogBox(winmain_instance, (LPCTSTR)(UINT_PTR)IDD_PLUS60K_SETTINGS_DIALOG, hwnd, dialog_proc);
//}
