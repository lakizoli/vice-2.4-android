...
//    int is_enabled;
//
//    is_enabled = (IsDlgButtonChecked(hwnd, IDC_C64_256K_ENABLE) == BST_CHECKED) ? 1 : 0;
//
...
//{
//    DialogBox(winmain_instance, (LPCTSTR)IDD_C64_256K_SETTINGS_DIALOG, hwnd, dialog_proc);
//}
